...
Cg3 = S.Cg;
k3 = S.k;
Ce3 = sqrt(omega^2-f^2)./(k4.^2);                % eigen-speed
...
% CASE 1
[r2u1,p1] = compute_modfit(pertp,dz,Ueig1,nmodes); 

% CASE 2
[r2u2,p2] = compute_modfit(pertp,dz,Ueig2,nmodes); 

% CASE 3
[r2u3,p3] = compute_modfit(pertp,dz,Ueig3,nmodes); 

% CASE 4
[r2u4,p4] = compute_modfit(pertp,dz,Ueig4,nmodes); 
